///! \file
/// Getopt paramters for u1_mc.cpp - Option parser
...
std::size_t Lt = 6;
std::size_t Ls = 6;
std::size_t or_param = 0;
std::size_t hit_param = 1;
double beta0 = 0.0;
...
static struct option long_options[] = {
  ...
  { "overrelaxation", required_argument, NULL, 'o' },
  { "mc-hits", required_argument, NULL, 'h' },
...
static char short_option_list[] = "b:m:s:t:f:S:T:n:vo:h:";
  ...
  while (1) {
    ...
    switch (c) {
      ...
      case 'f':
        ...
        break;
      case 'o':
        or_param = static_cast<std::size_t>(std::stoi(optarg));
        break;
      case 'h':
        hit_param = static_cast<std::size_t>(std::stoi(optarg));
        break;
      case 'v':
        quiet = 0;
        break;
...
void print_params()
{
  ...
  std::cout << std::setw(f1_width) << "\tMC hits: " << hit_param << std::endl;
  std::cout << std::setw(f1_width) << "\tOR sweeps: " << or_param << std::endl;
  std::cout << std::setw(f1_width)
