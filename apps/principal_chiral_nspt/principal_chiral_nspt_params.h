/// \file
/// Getopt paramters for principal_chiral_nspt.cpp - Header
...
extern int seq_init;       ///< Sequential (order by order)
                           /// thermalisation?
...
extern int no_meas;        ///< Switch off measurements and only
                           /// generate
///< configs
...
extern std::size_t constr_int;      ///< Number of steps between constraint
                                    /// enforcements
extern std::size_t swps;            ///< Number of time steps between
                                    /// measurements
extern std::size_t thermal;         ///< Number of thermalisation time steps
extern std::size_t Lt;              ///< Temporal extend of lattice
extern std::size_t Ls;              ///< Spatial extend of lattice
extern std::string file_identifier; ///< A string added to the standard file
                                    /// name to make it unique

/// Parse parameters
int parse_command_line_options(int argc, char *argv[]);
/// Print current value of parameters
void print_params();
